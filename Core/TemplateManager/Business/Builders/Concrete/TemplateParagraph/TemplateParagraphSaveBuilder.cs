...
{
    /// <summary>
    /// Implementazione del Builder per la TemplateParagraph
    /// </summary>
    internal class TemplateParagraphSaveBuilder : ITemplateParagraphSaveBuilder
    {
        ...
        public void Build(ITemplateParagraph input, TemplateParagraphSaveBuilderArgs args = null)
        {
            if (input == null)
