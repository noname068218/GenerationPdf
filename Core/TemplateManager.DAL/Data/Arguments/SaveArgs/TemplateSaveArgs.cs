...
{
    /// <summary>
    /// Argomenti relativi all'operazione di update per l'entità <see cref="TemplateManager.DAL.DomainModel.ITemplateObjectModel"/>.
    /// </summary>
    public class TemplateSaveArgs : SaveArgs
    {
