...
namespace TemplateManager.DAL.DomainModel
{
    ...
    /// </summary>
    public interface ITemplateParagraphAdapter : IObjectModel
    {
        ...
        /// </value>
        /// <exception cref=System.ArgumentNullException></exception>
        String PresentationInfo { get; set; }
