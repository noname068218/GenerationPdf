...
pdfjs-editor-alt-text-settings-ai-model-description = Est esecutadu in AlphaCode in manera chi is datos tuos abarrent in privadu. Rechestu pro sa generatzione automàtica de testu alternativu.
